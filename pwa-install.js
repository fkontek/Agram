    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      banner.innerHTML = `
        ...
        <div class="pwa-install-body">
          Instalirajte <strong>Agram Pilates</strong> na svoj iPhone: dodirnite ikonu dijeljenja 
          ...
          na dnu ekrana, a zatim odaberite <strong>Dodaj na početni zaslon</strong>.
        </div>
      `;
